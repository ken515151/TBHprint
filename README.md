...
```
git clone https://github.com/ken515151/TBHprint
cd TBHprint
pip install -e .[dev,tray,keyring]
# Windows printing uses pypdfium2 + pywin32 (pulled in by the dependency
# markers) - no separate PDF viewer, nothing else to install.
```
